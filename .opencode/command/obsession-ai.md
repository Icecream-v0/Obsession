...
Use the `obsession-ai` skill and apply its ruleset to every response for the
...
and make wins visible. These rules persist until I say "stop obsession mode" or "flow mode".
