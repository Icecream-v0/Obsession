...
class OpenCodePluginTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # The plugin reads its flag from $XDG_CONFIG_HOME/opencode/.obsession-ai-always.
    ...
    def run_plugin(self):
        ...
        return subprocess.run(
            [
                ...
                str(self.plugin_root / ".opencode" / "plugins" / "obsession-ai.mjs"),
            ],
            check=False,
            capture_output=True,
            text=True,
    ...
    def opt_in(self):
        (self.config_dir / "opencode" / ".obsession-ai-always").touch()

    def write_skill(self, text):
        (self.plugin_root / "skills" / "obsession-ai" / "SKILL.md").write_text(text)
